...
public class StudentDashboard extends JFrame {
    ...
    public StudentDashboard(String username) {
        ...
        StudentHome homePanel = new StudentHome(loggedInUsername);
        contentPanel.add(homePanel, "home");
        System.out.println("StudentHome panel added with card name: home");
        ...
        System.out.println("StudentFees panel added with card name: fees");
        // Debug print
        StudentBills billManagerPanel = new StudentBills(loggedInUsername);
        contentPanel.add(billManagerPanel, "bills");
        System.out.println("StudentBills panel added with card name: bills");
