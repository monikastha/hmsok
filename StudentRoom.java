    ...
    private void viewAssignedRoomDetails() {
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hostelms", "root", "");
             PreparedStatement pst = con.prepareStatement(
                     "SELECT r.room_floor_no, r.room_no, r.room_status, r.room_noof_std, r.room_type, s.std_hostel_status " + // Added std_hostel_status
            ...
            if (rs.next()) {
                ...
                String details = "<html><b>Floor:</b> " + rs.getString("room_floor_no") +
                        ...
                        " &nbsp;&nbsp; <b>Room Status:</b> " + rs.getString("room_status") +
                        " &nbsp;&nbsp; <b>No. of Students:</b> " + rs.getInt("room_noof_std") +
                        " &nbsp;&nbsp; <b>Type:</b> " + rs.getString("room_type") +
                        " &nbsp;&nbsp; <b>Hostel Status:</b> " + rs.getString("std_hostel_status") + "</html>"; // Display std_hostel_status
