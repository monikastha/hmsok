...
public class StudentSidebar extends JPanel {
    ...
    public StudentSidebar(CardLayout cardLayout, JPanel contentPanel) {
        ...
        JButton btnViewHome = new JButton("Home");
        styleButton(btnViewHome);
        btnViewHome.addActionListener(e -> cardLayout.show(contentPanel, "home"));
        // ==== View Room Section ====
        ...
        styleButton(btnViewBills);
        btnViewBills.addActionListener(e -> cardLayout.show(contentPanel, "bills"));
